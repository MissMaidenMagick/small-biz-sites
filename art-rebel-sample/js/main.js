...
document.querySelectorAll('.booking-form').forEach(form => {
  form.addEventListener('submit', (e) => {
    ...
    const artist = form.getAttribute('data-artist') || 'Art Rebel Tattoo';
    const to = form.getAttribute('data-to') || 'artrebeltattoo@gmail.com';
    const subject = encodeURIComponent(`Consultation request for ${artist} — ${data.get('name') || ''}`);
    const lines = [
      `Name: ${data.get('name') || ''}`,
